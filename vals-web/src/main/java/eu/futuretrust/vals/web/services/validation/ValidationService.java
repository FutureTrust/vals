...
package eu.futuretrust.vals.web.services.validation;
...
public interface ValidationService {
  ...
  VerifyResponseType validate(final VerifyRequestType verifyRequest,
      final DSSResponseType responseType) throws VerifyRequestException, ProfileNotFoundException;
}
