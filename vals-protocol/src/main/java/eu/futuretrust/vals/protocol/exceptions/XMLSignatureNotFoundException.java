...
public class XMLSignatureNotFoundException extends SignedObjectNotFoundException {

  public XMLSignatureNotFoundException(final String message,
      final ResultMajor resultMajor,
      final ResultMinor resultMinor) {
    super(message, resultMajor, resultMinor);
  }

  public XMLSignatureNotFoundException(final Throwable cause,
      final ResultMajor resultMajor,
      final ResultMinor resultMinor) {
