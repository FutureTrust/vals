...
public class SignedObjectNotFoundException extends SignedObjectException {

  public SignedObjectNotFoundException(final String message,
      final ResultMajor resultMajor,
      final ResultMinor resultMinor) {
    super(message, resultMajor, resultMinor);
  }

  public SignedObjectNotFoundException(final Throwable cause,
      final ResultMajor resultMajor,
      final ResultMinor resultMinor) {
